...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260312113225_AddHasVacationOnChristmasEveAndNewYearsEve")]
    partial class AddHasVacationOnChristmasEveAndNewYearsEve
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Organizations.Organization", b =>
                {
                    ...
                    b.Property<bool>("HasVacationOnChristmasEveAndNewYearsEve")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.PersonnelTeams.PersonnelTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Consultants.Consultant", b =>
                {
                    ...
                    b.HasOne("Core.PersonnelTeams.PersonnelTeam", "PersonnelTeam")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Core.PersonnelTeams.PersonnelTeam", b =>
                {
                    b.HasOne("Core.Consultants.Consultant", "Leader")
                        .WithOne()
                        .HasForeignKey("Core.PersonnelTeams.PersonnelTeam", "LeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
